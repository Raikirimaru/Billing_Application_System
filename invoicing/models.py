...
class Customer(models.Model):
    ...
    Args:
        models (Customer): Customer model definition
    """
    SEX_TYPE = (
        ('M', 'Man'),
        ('W', 'Woman')
...
class Invoice(models.Model):
    ...
    Args:
        models (Invoice): Invoice model definition
    """
    INVOICE_TYPE = (
        ('R', 'RECIEPT'),
        ('P', 'PROFORMA INVOICE'),
    ...
    comments = models.TextField(null=True, blank=True, max_length=999)
    ...
    def __str__(self):
        return f"{self.customer.name}_{self.incoice_date_time}"
...
class Article(models.Model):
    ...
    Args:
        models (Article) : Article model definition
    """  
